...
export default function OnboardingLocation() {
  ...
  const handleAllowLocation = () => {
    ...
    // Navigate to basics onboarding step
    ...
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      ...
      <div className="flex items-center justify-between px-6 py-3 h-18">
        ...
        <div className="flex-1 mx-4 h-3 bg-gray-200 rounded-full">
          <div className="w-full h-full bg-[#9610FF] rounded-full"></div>
        </div>
          ...
          <div className="mb-8 flex justify-center">
            <div className="w-32 h-32 rounded-full border border-gray-200 flex items-center justify-center">
              <div className="relative">
                <MapPin className="w-15 h-15 text-gray-900" size={60} />
                {/* Inner circle for location pin */}
