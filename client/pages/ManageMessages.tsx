          ...
          <div className="flex items-start justify-between w-full">
            <div className="flex-1">
              ...
              <p className="text-base text-gray-600">
                If this is turned off, your matches will have to send a
                connection request to you in order to connect in the message.
              </p>
            </div>
            <div className="pt-1">
              <button
                onClick={() => setReceiveDirectMessages(!receiveDirectMessages)}
                className={`w-11 h-6 rounded-full transition-colors ${
                  receiveDirectMessages ? "bg-purple-600" : "bg-gray-300"
                }`}
              >
                <div
                  className={`w-5 h-5 bg-white rounded-full transition-transform ${
                    receiveDirectMessages ? "translate-x-5" : "translate-x-0.5"
                  }`}
                />
              </button>
            </div>
          ...
          <div className="flex items-start justify-between w-full">
            ...
            <div className="pt-1">
              <button
                ...
                className={`w-11 h-6 rounded-full transition-colors ${
                  readReceipts ? "bg-purple-600" : "bg-gray-300"
                }`}
              >
                <div
                  className={`w-5 h-5 bg-white rounded-full transition-transform ${
