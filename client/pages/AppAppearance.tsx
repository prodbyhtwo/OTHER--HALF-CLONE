...
const ThemeModal: React.FC<{
...
}> = ({ isOpen, onClose, selectedTheme, onThemeSelect }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm z-50 flex items-end">
      <div className="w-full bg-white rounded-t-3xl p-6 pb-9">
          ...
          {themes.map((theme) => (
            ...
            >
              <div className="relative w-6 h-6">
                <div className="w-6 h-6 border-2 border-purple-600 rounded-full bg-white"></div>
        ...
        <div className="flex gap-4">
          <button
            onClick={onClose}
            className="flex-1 bg-purple-100 text-purple-600 font-bold text-base py-4 rounded-full"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 bg-purple-600 text-white font-bold text-base py-4 rounded-full"
          >
            OK
          </button>
        </div>
...
const AppAppearance: React.FC = () => {
  ...
  const handleLanguageClick = () => {
    navigate("/settings/app-language");
  };
    ...
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      ...
      <div className="flex-1 px-6 py-6">
        <div className="space-y-7">
          ...
          >
            <span className="text-xl font-semibold text-gray-900">Theme</span>
            <div className="flex items-center">
              <span className="text-base font-semibold text-gray-900 mr-5 capitalize">
                {selectedTheme}
              </span>
