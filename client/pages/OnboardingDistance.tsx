...
export default function OnboardingDistance() {
  ...
  const sliderPosition = (distance / 100) * 100;
    ...
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      ...
      <div className="flex items-center justify-between px-6 py-3 h-18">
        ...
        <div className="flex-1 mx-4 h-3 bg-gray-200 rounded-full">
          <div className="w-[67%] h-full bg-[#9610FF] rounded-full"></div>
        </div>
      ...
      <div className="flex-1 px-6 py-3 overflow-y-auto">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-gray-900 text-xl font-bold leading-8">
              Distance Preference
            </h2>
            <span className="text-gray-700 text-xl font-medium leading-8">
              {distance} km
            </span>
          </div>
          ...
          <div className="relative mb-6">
            <div className="w-full h-1.5 bg-gray-200 rounded-full">
              <div
                className="h-full bg-[#9610FF] rounded-full"
                style={{ width: `${sliderPosition}%` }}
              ></div>
            </div>
            <div
              className="absolute top-1/2 transform -translate-y-1/2 w-6 h-6 bg-white border-[5px] border-[#9610FF] rounded-full cursor-pointer shadow-sm"
