      ...
      <div className="flex-1 px-6 py-6">
        <div className="space-y-7">
          {supportOptions.map((option, index) => (
            ...
            >
              <span className="text-xl font-semibold text-gray-900 group-hover:text-[#9610FF] transition-colors">
                {option.title}
              </span>
              <ChevronRight className="w-6 h-6 text-gray-800 group-hover:text-[#9610FF] transition-colors" />
            </button>
          ))}
        </div>
      </div>
