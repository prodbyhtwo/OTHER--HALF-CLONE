...
export default function SignUp() {
  ...
  const isFormValid = email && password && agreedToPolicy;
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center px-6 py-3 h-18">
        <Link to="/signin" className="flex items-center justify-center w-7 h-7">
          ...
          <div className="space-y-7">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={cn(
                      "h-16 pl-12 pr-12 text-lg bg-gray-50 border-gray-50 rounded-xl",
                      password ? "text-gray-900" : "text-gray-400",
                      "focus:border-purple-600 focus:ring-purple-600",
                    )}
            ...
            <div className="flex items-start space-x-4">
              <Checkbox
                ...
                className="w-6 h-6 mt-0.5 border-2 border-purple-600 data-[state=checked]:bg-purple-600 data-[state=checked]:border-purple-600"
              />
              <Label
                htmlFor="privacy"
                className="text-lg font-semibold text-gray-900 cursor-pointer leading-relaxed"
              >
                I agree to Datify{" "}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 py-6 pb-9">
        <Button
          ...
          className={cn(
            "w-full h-14 font-bold text-base rounded-full",
            isFormValid
