  ...
  const sections = [
    {
      ...
      content: `• Datify collects user data, including personal information, to provide and improve our services.
• Information collected may include profile data, location, and usage patterns.`,
    },
    {
      title: "2. Data Use",
      content: `• We use data to facilitate matching, communication, and personalization of the app.
• Your data may be shared with third-party service providers for app functionality.`,
    },
    {
      title: "3. Data Protection",
      content:
        "Datify employs security measures to protect user data. However, no system is entirely foolproof, and we cannot guarantee absolute security.",
    },
    {
    ...
    },
    {
      ...
      content:
        "Datify may contain links to third-party websites or services. We are not responsible for their privacy practices.",
    },
    {
      title: "6. Data Retention",
      content: `• We retain user data as long as necessary for app functionality or as required by law.
• Users can request data deletion through the app settings.`,
    },
    {
      title: "7. Communication",
      content:
        "By using Datify, you consent to receive app-related communications, including notifications and updates.",
    },
    {
      title: "8. Children's Privacy",
      content:
        "Datify is not intended for users under 18. We do not knowingly collect data from children.",
    },
    {
      title: "9. Changes to Privacy Policy",
      content:
        "Datify may update the Privacy Policy. Users will be notified of changes, and continued use implies acceptance.",
    },
    {
      title: "10. Contact",
      content:
        "For questions or concerns about privacy or these policies, please contact Datify support through the app.",
    },
  ];
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-lg text-gray-700 leading-relaxed">
                By using Datify, you acknowledge and agree to the Privacy Policy
                outlined above. Your privacy and security are important to us,
