...
export default function NotificationSettings() {
  ...
  const notificationItems = [
    ...
    { key: "likesAndSuperLikes", label: "Likes & Super Likes" },
    { key: "profileVisitors", label: "Profile Visitors" },
    { key: "eventsAndActivities", label: "Events and Activities" },
    { key: "matchesActivity", label: "Matches' Activity" },
    { key: "safetyAndAccountAlerts", label: "Safety & Account Alerts" },
    { key: "promotionsAndNews", label: "Promotions & News" },
    { key: "inAppRecommendations", label: "In-App Recommendations" },
    { key: "weeklyActivitySummary", label: "Weekly Activity Summary" },
    { key: "connectionRequests", label: "Connection Requests" },
    { key: "surveyAndFeedbackRequests", label: "Survey & Feedback Requests" },
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 pb-20">
        {/* Tab Selection */}
        <div className="mb-7 p-2 bg-gray-100 rounded-md">
          <div className="flex">
            <button
              onClick={() => setActiveTab("push")}
              className={`flex-1 py-2 px-3 rounded-md text-base font-semibold transition-all ${
                activeTab === "push"
