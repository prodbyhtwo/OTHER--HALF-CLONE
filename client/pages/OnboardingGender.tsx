...
const genderOptions: GenderOption[] = [
  ...
  { id: "more", label: "More", hasIcon: true },
];
    ...
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      ...
      <div className="flex items-center justify-between px-6 py-3 h-18">
        ...
        <div className="flex-1 mx-4 h-3 bg-gray-200 rounded-full">
          <div className="w-2/3 h-full bg-[#9610FF] rounded-full"></div>
        </div>
        ...
        <div className="space-y-6 mb-6">
          {genderOptions.map((option) => (
            <button
              ...
              className={`w-full px-6 py-3 rounded-full text-lg font-bold transition-all flex items-center justify-center gap-2 ${
            ...
            >
              ...
              {option.hasIcon && <ChevronRight className="w-5 h-5" />}
            </button>
          ))}
        </div>
      </div>
