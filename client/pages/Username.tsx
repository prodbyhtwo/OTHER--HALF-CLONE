    ...
    <div className="min-h-screen bg-white flex flex-col max-w-[430px] mx-auto">
      ...
      <div className="flex-1 px-6 py-6">
        <div className="mb-3">
          ...
          <div className="bg-gray-50 border border-gray-50 rounded-xl px-5 py-4.5">
            <input
              type="text"
              value={username}
              onChange={(e) => setUsername(e.target.value)}
              className="w-full bg-transparent text-lg font-semibold text-gray-900 placeholder-gray-500 outline-none"
      ...
      <div className="px-6 py-6 border-t border-gray-100">
        <button
          onClick={handleSave}
          className="w-full bg-purple-600 text-white font-bold text-base py-4 rounded-full"
        >
          Save
        </button>
      </div>
      ...
      <div className="h-72 bg-gray-100 flex items-center justify-center">
        <div className="text-gray-500 text-sm">Virtual Keyboard Area</div>
      </div>
    </div>
  );
};
