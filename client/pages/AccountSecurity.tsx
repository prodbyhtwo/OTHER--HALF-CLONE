...
export default function AccountSecurity() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 pb-20 space-y-7">
        ...
        <div className="space-y-7">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => toggleSetting("rememberMe")}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                settings.rememberMe ? "bg-purple-600" : "bg-gray-300"
              }`}
            >
              <span
                className={`${
                  settings.rememberMe ? "translate-x-6" : "translate-x-1"
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                settings.biometricId ? "bg-purple-600" : "bg-gray-300"
              }`}
            >
              <span
                className={`${
                  settings.biometricId ? "translate-x-6" : "translate-x-1"
                } inline-block h-4 w-4 transform rounded-full bg-white transition`}
              />
            </button>
          </div>
          ...
          {/* Face ID */}
          <div className="flex items-center justify-between">
            <span className="text-xl font-semibold text-gray-900">Face ID</span>
            <button
              onClick={() => toggleSetting("faceId")}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                settings.faceId ? "bg-purple-600" : "bg-gray-300"
              }`}
            >
              <span
                className={`${
                  settings.faceId ? "translate-x-6" : "translate-x-1"
                } inline-block h-4 w-4 transform rounded-full bg-white transition`}
              />
            </button>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => toggleSetting("smsAuthenticator")}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                settings.smsAuthenticator ? "bg-purple-600" : "bg-gray-300"
              }`}
            >
              <span
                className={`${
                  settings.smsAuthenticator ? "translate-x-6" : "translate-x-1"
                } inline-block h-4 w-4 transform rounded-full bg-white transition`}
              />
            </button>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => toggleSetting("googleAuthenticator")}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                settings.googleAuthenticator ? "bg-purple-600" : "bg-gray-300"
              }`}
            >
              <span
                className={`${
                  settings.googleAuthenticator
                    ? "translate-x-6"
                    : "translate-x-1"
                } inline-block h-4 w-4 transform rounded-full bg-white transition`}
              />
          ...
          <button className="w-full text-left">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-base text-gray-600">
                  Temporarily hide your profile. Easily reactivate when you're
                  ready.
                </p>
              </div>
              <ChevronRight className="w-6 h-6 text-gray-400 mt-1" />
          ...
          <button className="w-full text-left">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-base text-gray-600">
                  Permanently remove your profile and data from Datify. Proceed
                  with caution.
                </p>
              </div>
              <ChevronRight className="w-6 h-6 text-gray-400 mt-1" />
