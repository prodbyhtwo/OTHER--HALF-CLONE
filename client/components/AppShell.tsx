...
function NavigationMenu({ items, title, currentPath, onNavigate }: NavigationMenuProps) {
  return (
      ...
      <nav className="space-y-1">
        {items.map((item) => {
          ...
          return (
            ...
            >
              <item.icon className={cn("h-4 w-4", isActive ? "text-primary-600" : "text-gray-500")} />
...
export function AppShell({ 
  ...
  const adminNav = filterNavigationByPermissions(ADMIN_NAVIGATION, userPermissions);
