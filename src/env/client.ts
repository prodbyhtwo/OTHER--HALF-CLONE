...
export const hasStripePublic =
  !envClient.VITE_SAFE_MODE && !!envClient.VITE_STRIPE_PUBLISHABLE_KEY;
export const hasRecaptcha =
  !envClient.VITE_SAFE_MODE && !!envClient.VITE_RECAPTCHA_SITE_KEY;
export const hasSentry =
  !envClient.VITE_SAFE_MODE && !!envClient.VITE_SENTRY_DSN;
export const hasAnalytics =
  !envClient.VITE_SAFE_MODE && !!envClient.VITE_ANALYTICS_API_KEY;
